...
public class EduVideoController {
    ...
    public R save(@ApiParam(name="videoForm", value = "课时对象", required = true)
        ...
        boolean result = videoService.saveVideoInfo(videoInfoForm);
        if(result){
           return R.ok();
        }else {
    ...
    public R getVideoInfoById(@ApiParam(name = "id", value = "课时ID", required = true)
        ...
        VideoInfoForm videoInform = videoService.getVideoInformById(id);
        return R.ok().data("item", videoInform);
    ...
    public R updateCourseInfoById(
            ...
            @RequestBody VideoInfoForm videoInfoForm){
        videoService.updateVideoInfoForm(videoInfoForm);
        return R.ok();
    }
